...
/**Sarah Lum
 *11/25/19
 *choose to solve out of the four different mazes using BFS or DFS*/
public class Main {
	/**Main method 
	 * opens and reads in maze file, puts maze in a 2d char array 
	 * displays the menu */
	 ...
	 * @param mazeNum - the maze number being added in
	...
	public static char [][] readMaze(int mazeNum){
		...
		//construct the array
		//read in the first line, find the numbers and construct 2d array from those numbers
	...
	/**reads in the file of the maze
	 * @param displayedArray - array meant to be displayed*/
	...
	//find start
	/**traverse grid until you reach 's' then create a new object point with that row/column for x and y
	 * @param maze - the 2d char array
